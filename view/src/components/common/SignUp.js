...
function LoginForm() {
    ...
    const validationCheck = () => {
        ...
        if (!regExpPass.test(args["pass"])) {
            alert("パスワードは英語と数字を含めて8桁以上入力お願い致します。")
            flag = false
            return
        }
                ...
                <div className="div-outline">
                    <Form>
                        ...
                        <div className="form-group">
                            <label>ID</label>
                            <input type="text" className="form-control" ref={inputId} placeholder="IDを入力してください。" value="bluegmlduf"/>
                        </div>

                        <div className="form-group">
                            <label>パスワード</label>
                            <input type="password" className="form-control" ref={inputPass} placeholder="英語を含めた8桁~12桁を入力してください。" value="12345678a"/>
                        </div>

                        <div className="form-group">
                            <label>パスワードの確認</label>
                            <input type="password" className="form-control" ref={inputPassCheck} placeholder="パスワードをもう一度入力してください。" value="12345678a"/>
                        </div>

                        <div className="form-group">
                            <label>メールアドレス</label>
                            <div className="input-group mb-3">
                                <input type="email" ref={inputEmail} className="form-control" placeholder="メールアドバイスを入力してください。" value="bluegmlduf2@naver.com"/>
